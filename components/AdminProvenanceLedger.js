    ...
    <div className="space-y-8 font-sans text-slate-800">
      ...
      {editingBlock && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl p-6 sm:p-8 max-w-2xl w-full shadow-2xl border border-slate-200 text-xs animate-scale-in space-y-5 max-h-[92vh] overflow-y-auto">
      ...
      {deletingBlock && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl p-6 sm:p-8 max-w-md w-full shadow-2xl border border-red-200 text-xs animate-scale-in space-y-5 text-center">
      ...
      {isMintModalOpen && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl p-6 sm:p-8 max-w-2xl w-full shadow-2xl border border-slate-200 text-xs animate-scale-in space-y-4 max-h-[92vh] overflow-y-auto">
